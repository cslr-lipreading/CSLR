    ...
    def calculate(self, lab, rec):
        ...
        while True:
            if self.space[i][j]['error'] == 'cor':  # correct
                ...
                print('this should not happen , i = {i} , j = {j} , error = {error}'.format(i=i, j=j,
                                                                                            error=self.space[i][j][
                                                                                                'error']))
        return result
...
# compute-wer.py --char=1 --v=1 ../../data/truth.txt ../../data/pred.txt > ../../data/wer.txt
